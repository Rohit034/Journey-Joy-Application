...
//		.and()
		...
		.antMatchers("/users/searchDestination","/users/createtour","/users/addTourReview","/users/makeBooking","/users/gethotels","/users/makePayment").hasRole("CUSTOMER")//permitAll()
